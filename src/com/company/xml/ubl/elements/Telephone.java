...
public class Telephone {
    ...
    private String name = ElementsName.TELEPHONE.label;
     ...
     */
    private Telephone(TelephoneBuilder builder) {
    ...
    public static class TelephoneBuilder {
        ...
        public TelephoneBuilder documentLinked(Document doc){
            this.doc = doc;
            return this;
        }
        public TelephoneBuilder elementFather(Element element){
            this.element = element;
            return this;
        }
        public TelephoneBuilder value(String value){
            this.value = value;
            return this;
        }
        public TelephoneBuilder attributes(PatternLanguage patternLanguage){
            this.patternLanguage = patternLanguage;
            return this;
        }
        public Telephone build(){
            Telephone elementBuild = new Telephone(this);
            return elementBuild;
        }
