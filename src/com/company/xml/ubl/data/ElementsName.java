...
public enum ElementsName {
    ...
    TAX_EXCLUSIVE_AMOUNT(NamespacesName.CBC_NAMESPACE.label+"TaxExclusiveAmount"),
    TAX_INCLUSIVE_AMOUNT(NamespacesName.CBC_NAMESPACE.label+"TaxInclusiveAmount"),
    PAYABLE_AMOUNT(NamespacesName.CBC_NAMESPACE.label+"PayableAmount"),
    ...
    CREDITED_QUANTITY(NamespacesName.CBC_NAMESPACE.label+"CreditedQuantity"),
