...
public class PaymentChannelCode {
    ...
    private String name = ElementsName.PAYMENT_CHANNEL_CODE.label;
    private String value;
    private PatternList patternList;

    /**
     * <h2>Element "PaymentChannelCode"</h2>
     * <p>The Payment Channel, expressed as a code. Contains :</p>
     * <ul>
     ...
     * </ul>
     */
    private PaymentChannelCode(PaymentChannelCodeBuilder builder) {
    ...
    /**
     * Builder PaymentChannelCode
     */
    public static class PaymentChannelCodeBuilder {
        ...
        public PaymentChannelCodeBuilder() {}

        public PaymentChannelCodeBuilder documentLinked(Document doc){
            this.doc = doc;
            return this;
        }
        public PaymentChannelCodeBuilder elementFather(Element element){
            this.element = element;
            return this;
        }
        public PaymentChannelCodeBuilder value(String value){
            this.value = value;
            return this;
        }
        public PaymentChannelCodeBuilder attributes(PatternList patternList){
            this.patternList = patternList;
            return this;
        }
        public PaymentChannelCode build(){
            PaymentChannelCode element = new PaymentChannelCode(this);
            return element;
        }
